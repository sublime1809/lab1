...
class FoursquareApi {
  ...
  private $AuthorizeUrl = "https://foursquare.com/oauth2/authorize";
     ...
     */
	public function  __construct($redirect_uri='', $version='v2', $language='en', $api_version='20120228'){
		$this->BaseUrl = "{$this->BaseUrl}$version/";
		$this->ClientID = "EZEI4PDG0CJEMSPOKGIHC412UDBS521YZD52X3EJ0LH5RRQR";
		$this->ClientSecret = "O3T30EP3VF4DC14QA2OJ0HED5T2BC4VJZ3IEZWWXIPZNIOCB";
